...
import FollowHeader from "../components/FollowComponents/FollowHeader";
      ...
      <div className="min-h-screen">
        <div className="border-x-divider grid grid-cols-2 grid-rows-1 border-b">
          {tabs.map((tab) => (
            ...
            >
              {({ isActive }) => (
                <div className="hover:bg-x-divider/35 flex cursor-pointer items-center justify-center px-6 transition-all duration-200 ease-in-out">
