...
const CreatePostModal = ({ isModal = false, onClose }) => {
    ...
    return (
      <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/55 px-4 py-6 backdrop-blur-[2px] sm:py-10">
        ...
        <div className="relative z-[101] w-full max-w-2xl">
          <div className="bg-x-bg border-x-divider overflow-hidden rounded-2xl border shadow-2xl">
  ...
  return (
    <div className="min-h-screen">
      <div className="border-x-divider sticky top-0 z-50 rounded-lg border-b px-3 py-2 backdrop-blur-3xl">
